...
The following pattern works with **published 1.4.1** and an existing npm project. It does not require a new FailTrace configuration format or background service. For other projects, use the same explicit commands in the project's existing task runner.
