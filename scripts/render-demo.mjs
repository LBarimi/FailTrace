...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="960" height="438" viewBox="0 0 960 438" role="img" aria-labelledby="title description">
<title id="title">FailTrace: reproduce, minimize, replay</title>
<desc id="description">A real guided demo recorded ${stats.passed} passing and ${stats.failed} failing trials, reduced ${demo.reduction.originalInput.length} JSON elements to ${escape(JSON.stringify(demo.reduction.minimizedInput))}, and created a replayable bundle.</desc>
<rect width="960" height="438" rx="18" fill="#0c1523"/>
...
${text(34, 225, '02  MINIMIZE', '#81b4ff', 16)}
${text(70, 260, `${demo.reduction.originalInput.length} JSON elements  →  ${JSON.stringify(demo.reduction.minimizedInput)}   final failure verified`)}
${text(34, 309, '03  SHARE A REPRODUCTION', '#81b4ff', 16)}
${text(70, 344, 'Bundle created: source + input + logs + replay scripts')}
${text(34, 402, 'Actual demo results. Full evidence: .failtrace/demos/<id>/', '#8fa5bf', 14)}
</g></svg>\n`;
