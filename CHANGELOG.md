...
## 1.0.0-rc.1 — source release candidate

Publication is recorded separately after the exact public archive is verified. The currently documented stable npm installation remains 0.6.0.
